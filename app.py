...
full_path=r"C:\Users\saipr\OneDrive\Desktop\Detecting_drowsiness_and_alert_driver\shape_predictor_68_face_landmarks.dat"
predictor = dlib.shape_predictor(full_path)
...
def _init_(self, threshold=0.08):
